...
class ContacModelTest(TestCase):
    ...
    def test_choices(self):
        ...
        self.assertRaises(ValidationError, contact.full_clean) # full_clean no model pois evoluiu para ModelForm.
...
class ContactManagerTest(TestCase):
    ...
    def test_emails(self):
        qs = Contact.objects.emails() #Contact.emails.all()
        expected = ['henrique@bastos.net']
        self.assertQuerysetEqual(qs, expected, lambda o: o.value)

    def test_phones(self):
        qs = Contact.objects.phones() #Contact.phones.all()
